...
export function IntroSection(){
    ...
    <section id='intro' className='space-y-6 py-8 md:py:12 lg:py-32 relative'>
        ...
        <div className='container flex max-w-[64rem] flex-col items-center gap-4'>
          ...
          <h1 className='font-heading text-4xl md:text-6xl lg:text-7xl flex flex-col items-center'>
            The NEXT DEV <br/>
            <span className='text-primary'>Full-Stack</span> 
          </h1>
          <p className='max-w-[42rem] leading-normal text-muted-foreground text-center sm:text-xl sm:leading-8'>
          O processo de aprendizado esta em mais que 80% sobre praticar o uso e menos que 20% em saber a teorica daquela ferramenta.
          </p>
